...
### AdGuard DNS Proxy
[![Packaging status](https://repology.org/badge/vertical-allrepos/dnsproxy-adguard.svg?exclude_unsupported=1)](https://repology.org/project/dnsproxy-adguard/versions)<br>![Winget](https://img.shields.io/winget/v/AdGuard.dnsproxy?label=🞝&emsp;&emsp;&emsp;&emsp;%20&emsp;&emsp;&emsp;Winget)<br>![Winget](https://img.shields.io/winget/v/AdGuard.dnsproxy)

### EPSON Scan 2
[![Packaging status](https://repology.org/badge/vertical-allrepos/epsonscan2.svg?exclude_unsupported=1)](https://repology.org/project/epsonscan2/versions)<br>
![Winget](https://img.shields.io/winget/v/EPSON.EpsonScan2?label=🞝&emsp;&emsp;&emsp;&emsp;%20&emsp;&emsp;Winget)
